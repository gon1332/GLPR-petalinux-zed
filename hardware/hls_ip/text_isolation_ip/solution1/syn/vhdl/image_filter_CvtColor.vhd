...
architecture behav of image_filter_CvtColor is 
    ...
    signal tmp_75_reg_322 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_76_reg_327 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_reg_ppstg_tmp_76_reg_327_pp0_it2 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_9_reg_342 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal p_Val2_7_fu_209_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal tmp_9_i_i_i_fu_258_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal p_Val2_10_fu_261_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_73_fu_266_p3 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (not(((ap_sig_bdd_92 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)) or (ap_sig_bdd_104 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it4))))) then
                ...
                ap_reg_ppstg_tmp_76_reg_327_pp0_it2 <= tmp_76_reg_327;
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_sig_bdd_92 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)) or (ap_sig_bdd_104 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it4)))) and (ap_const_lv1_0 = ap_reg_ppstg_exitcond_reg_313_pp0_it2))) then
                p_Val2_9_reg_342 <= r_V_1_fu_227_p2(31 downto 24);
                tmp_72_reg_352 <= r_V_1_fu_227_p2(31 downto 31);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sig_cseq_ST_pp0_stg0_fsm_2) and (exitcond_reg_313 = ap_const_lv1_0) and not(((ap_sig_bdd_92 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it1)) or (ap_sig_bdd_104 and (ap_const_logic_1 = ap_reg_ppiten_pp0_it4)))))) then
                ...
                tmp_75_reg_322 <= p_src_data_stream_0_V_dout;
                tmp_76_reg_327 <= p_src_data_stream_1_V_dout;
            end if;
        end if;
    end process;
    ...
    not_carry_fu_279_p2 <= (tmp_73_fu_266_p3 or p_Result_4_i_i_i_not_fu_274_p2);
    p_Result_4_i_i_i_not_fu_274_p2 <= (tmp_72_reg_352 xor ap_const_lv1_1);
    p_Val2_10_fu_261_p2 <= std_logic_vector(unsigned(p_Val2_9_reg_342) + unsigned(tmp_9_i_i_i_fu_258_p1));
    p_Val2_7_fu_209_p2 <= std_logic_vector(unsigned(r_V_4_i_reg_332) + unsigned(tmp1_i_cast_fu_205_p1));
    p_dst_data_stream_V_din <= 
        p_Val2_10_fu_261_p2 when (not_carry_fu_279_p2(0) = '1') else 
        ap_const_lv8_FF;
    ...
    r_V_3_i_fu_221_p00 <= std_logic_vector(resize(unsigned(ap_reg_ppstg_tmp_76_reg_327_pp0_it2),32));
    ...
    r_V_fu_199_p00 <= std_logic_vector(resize(unsigned(tmp_75_reg_322),30));
    ...
    tmp_73_fu_266_p3 <= p_Val2_10_fu_261_p2(7 downto 7);
    tmp_9_i_i_i_fu_258_p1 <= std_logic_vector(resize(unsigned(tmp_reg_347),8));
    tmp_i_cast_fu_214_p1 <= std_logic_vector(resize(unsigned(p_Val2_7_fu_209_p2),32));
end behav;
