...
image_filter_Mat2AXIvideo::image_filter_Mat2AXIvideo(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( ap_reg_ppiten_pp0_it1 );
    sensitive << ( tmp_cast_78_fu_219_p1 );
    ...
    SC_METHOD(thread_tmp_cast_78_fu_219_p1);
    sensitive << ( p_3_reg_170 );
    ...
    sc_trace(mVcdFile, tmp_cast_78_fu_219_p1, "tmp_cast_78_fu_219_p1");
...
void image_filter_Mat2AXIvideo::thread_axi_last_V_fu_223_p2() {
    axi_last_V_fu_223_p2 = (!tmp_cast_78_fu_219_p1.read().is_01() || !op2_assign_reg_267.read().is_01())? sc_lv<1>(): sc_lv<1>(tmp_cast_78_fu_219_p1.read() == op2_assign_reg_267.read());
}
...
void image_filter_Mat2AXIvideo::thread_tmp_cast_78_fu_219_p1() {
    tmp_cast_78_fu_219_p1 = esl_zext<13,12>(p_3_reg_170.read());
}
